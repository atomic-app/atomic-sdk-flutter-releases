...
class AACProcessedEvent {
  AACProcessedEvent.fromJson(Map<String, dynamic> json)
  ...
  Map<String, dynamic> get toJson {
    return {'name': name, 'lifecycleId': lifecycleId, 'version': version};
  }
}
...
class AACEventResponse {
  AACEventResponse.fromJson(Map<String, dynamic> json)
      : batchId = json["batchId"] as String {
    processedEvents = [];
    for (final processedRaw in json["processedEvents"] as Iterable) {
      processedEvents.add(
        AACProcessedEvent.fromJson(
          (processedRaw as Map).cast<String, dynamic>(),
        ),
      );
    }
  }
  ...
  Map<String, dynamic> get toJson {
    ...
    final processedEventsJson = <Map<String, dynamic>>[];
